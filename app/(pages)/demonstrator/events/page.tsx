...
import DemonstratorEventListItem from "@/components/cards/DemonstratorEventListItem";
...
const Events = () => {
  ...
  const getAllEvents = async () => {
    const data = await fetch("/api/post/get-demonstrator-events", {
      method: "POST",
    });
