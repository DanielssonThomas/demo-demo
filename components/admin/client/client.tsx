...
export const Client = ({ id }: ClientProps) => {
  return (
    <div className="flex flex-col p-4 bg-light-bg dark:bg-dark-bg text-black dark:text-white min-h-screen xl:h-screen">
      <div className="flex flex-col justify-center items-center xl:items-start h-screen xl:max-h-[80vh] xl:flex-row">
        ...
        <section className="w-full sm:w-[60vw] md:w-[50vw] xl:w-[50vw] h-full">
