...
export const DeleteEvent = ({ id, setDeleteEventActive }: DeleteEvent) => {
  ...
  return (
    <div className="absolute">
      ...
      />
      <section className="fixed top-[37.5vh] right-[37.5vw] left-[37.5vw] bottom-0 w-1/4 h-1/4 border-[1px] border-solid border-black rounded-md bg-light-bg dark:bg-dark-bg text-black dark:text-white p-4 z-40">
